...
class VR_remap_joy:
    ...
    def vr_translate_into_joy(self):
        #button 
        self.vr_to_joy.buttons[6] = self.vr_joy.buttons[0] # Back: manual
        self.vr_to_joy.buttons[7] = self.vr_joy.buttons[1] # Start: RL
        self.vr_to_joy.buttons[3] = self.vr_joy.buttons[2] # Y: DP
        self.vr_to_joy.buttons[4] = self.vr_joy.buttons[3] 
        self.vr_to_joy.buttons[0] = self.vr_joy.buttons[4] # A :sync
